...
void create_screen_roster() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 272, 480);
    lv_obj_add_event_cb(obj, action_screen_load_cb, LV_EVENT_SCREEN_LOADED, (void *)2);
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(obj, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
...
void create_screen_config() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 272, 480);
    lv_obj_add_event_cb(obj, action_screen_load_cb, LV_EVENT_SCREEN_LOADED, (void *)9);
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
...
void create_screen_credits() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffc89600), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 260, LV_SIZE_CONTENT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text(obj, "Those who helped with the original release:\n\nSteve (esfeld)\nErik (erik84750)\nLee (mtncityman)\nMichele (michele2796)\n\nMy sincere THANKS to ALL! \nNorm(normhal)");
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
